...
#Система уравнений:
#14.4x₁ - 5.3x₂ + 14.3x₃ - 12.7x₄ = 14.4
#23.4x₁ - 14.2x₂ - 5.4x₃ + 2.1x₄ = 6.6
#6.3x₁ - 13.2x₂ - 6.5x₃ + 14.3x₄ = 9.4
#5.6x₁ + 8.8x₂ - 6.7x₃ - 23.8x₄ = 7.3
...
matrix_b4 = np.array([14.4, 6.6, 9.4, 7.3])
print(f"Матрица А4 (4х4):\n{matrix_a4}\n")
print(f"Вектор B:\n{matrix_b4}\n")
